...
export default function MentionsLegalesPage() {
  return (
    <div className="min-h-screen bg-[#F4EFE5] py-12 px-4">
      <div className="mx-auto max-w-4xl rounded-3xl border border-[#d8ccb9] bg-white p-8 shadow-lg">
        <h1 className="text-4xl font-bold text-[#17324D] mb-8" style={{ fontFamily: "'Georgia', serif" }}>
          Mentions légales & Conditions Générales d'Utilisation
        </h1>

        <section className="space-y-6 text-[#17324D]/80">
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Éditeur du site</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Hébergement</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Protection des données (RGPD)</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Conditions Générales d'Utilisation</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Propriété intellectuelle</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#17324D] mb-3">Contact</h2>
        ...
        <div className="mt-12 pt-6 border-t border-[#d8ccb9]">
