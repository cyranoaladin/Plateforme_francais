      ...
      data: {
        ...
        profile: {
          create: {
            ...
            parentEmail: (input.profile as Record<string, unknown>).parentEmail as string ?? undefined,
            parentConsentToken: (input.profile as Record<string, unknown>).parentConsentToken as string ?? undefined,
            parentConsentStatus: (input.profile as Record<string, unknown>).parentConsentStatus as string ?? undefined,
          },
        },
      },
    });
