...
> = {
  grammaire: {
    ...
    icon: BrainCircuit,
    accent: 'from-[var(--color-coral-700)] via-[var(--color-coral-500)] to-[var(--color-coral-400)]',
  },
  problematisation: {
    href: '/atelier-ecrit',
    ...
    icon: BookOpen,
    accent: 'from-[var(--color-indigo-700)] via-[var(--color-indigo-500)] to-[var(--color-indigo-400)]',
  },
  'explication lineaire': {
    ...
    icon: Mic,
    accent: 'from-[var(--color-emerald-700)] via-[var(--color-emerald-500)] to-[var(--color-emerald-400)]',
  },
  'lecture cursive': {
    href: '/bibliotheque',
    ...
    icon: BookOpen,
    accent: 'from-[var(--color-amber-700)] via-[var(--color-amber-500)] to-[var(--color-amber-400)]',
  },
};
