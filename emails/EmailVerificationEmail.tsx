...
export default function EmailVerificationEmail({
  firstName = '',
  email = '',
  verifyUrl = 'https://eaf.nexusreussite.academy/verify-email',
  expiresAt = '',
}: EmailVerificationEmailProps) {
  return (
    <Html lang="fr">
      <Head />
      <Preview>Confirme ton adresse email pour activer ton compte Nexus Réussite.</Preview>
      <Body style={{ backgroundColor: '#F7F8FA', fontFamily: "system-ui, -apple-system, 'Segoe UI', sans-serif", margin: 0, padding: 0 }}>
        ...
        <Container style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <Section style={{ backgroundColor: '#ffffff', padding: '40px 40px 24px', textAlign: 'center' as const }}>
            <Text style={{ fontSize: '48px', margin: '0 0 16px' }}>✉️</Text>
            ...
            <Text style={{ color: '#4A5568', fontSize: '16px', margin: '0 0 32px', textAlign: 'center' as const }}>
              {firstName ? `Salut ${firstName}\u00A0! ` : ''}Clique sur le bouton ci-dessous pour vérifier ton adresse. Ce lien expire le {expiresAt}.
            </Text>
            <Button href={verifyUrl} style={{ backgroundColor: '#1E3A5F', color: '#ffffff', borderRadius: '8px', padding: '16px 32px', fontWeight: 600, fontSize: '16px', textDecoration: 'none', display: 'block', textAlign: 'center' as const }}>
          ...
          <Section style={{ backgroundColor: '#ffffff', padding: '0 40px 32px', borderRadius: '0 0 8px 8px' }}>
            <Section style={{ backgroundColor: '#FFF8E1', borderLeft: '4px solid #F59E0B', borderRadius: '0 8px 8px 0', padding: '16px 20px' }}>
              <Text style={{ color: '#92400E', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
                Si tu n'as pas créé de compte Nexus Réussite, ignore cet email.
              </Text>
            </Section>
          </Section>
          ...
          <Section style={{ backgroundColor: '#F7F8FA', padding: '24px 40px', borderRadius: '0 0 8px 8px' }}>
            <Text style={{ color: '#9CA3AF', fontSize: '13px', lineHeight: '1.6', margin: '0 0 8px' }}>
              Tu reçois cet email car un compte a été créé sur nexusreussite.academy avec l'adresse {email}.
            </Text>
